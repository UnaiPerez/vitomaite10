 ...
 * @author megan
 */
@WebServlet(name = "detallesMatching", urlPatterns = {"/detallesMatching"})
public class detallesMatching extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try(Connection conn = BD.getConnection()){
            if(action == null || action.isEmpty()){
                ...
                request.getRequestDispatcher("detallesMatching.jsp").forward(request, response);
                ...
                response.sendRedirect("detallesMatching?email=" + selectedEmail);
    ...
    public String getServletInfo() {
        return "Servlet para los detalles del matching";
    }// </editor-fold>
